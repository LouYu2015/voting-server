...
from .views import question_list_view, vote_count_view, judge_vote_count_view, \
    update_vote_view, get_selected_view, \
...
urlpatterns = [
    ...
    path('judge_vote_count/<int:id>/', judge_vote_count_view),  # Get vote count by judge for a question
